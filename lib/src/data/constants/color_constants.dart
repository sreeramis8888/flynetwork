...
const Color kPrimaryColor = Color(0xFF512DB4);
const Color kPrimaryLightColor = Color(0xFFF1ECFF);
...
const Color kGreyLight = Color.fromARGB(255, 227, 223, 223);
const Color kGreyDark = Color.fromARGB(255, 118, 121, 124);
const Color kGreyDarker = Color(0xFF585858);
const Color kRed = Color(0xFFEB5757);
const Color kOrange = Color(0xFFF58220);
...
const Color kViolet = Color(0xFF512DB4);
const Color kVioletLight = Color(0xFFF1ECFF);
